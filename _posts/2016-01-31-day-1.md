...
Solving this differential equation in the time domain is outside the scope of the class (since we're going to adopt a much more powerful method of deriving the functions governing circuit behavior soon), but one method of solving this equation is at the end of this recap.
